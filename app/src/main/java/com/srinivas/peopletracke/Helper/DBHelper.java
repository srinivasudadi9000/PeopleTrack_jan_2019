package com.srinivas.peopletracke.Helper;
...
public class DBHelper {
    ...
    public DBHelper(Context context) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS checktime(latitude VARCHAR,longitude VARCHAR,cdt VARCHAR,address VARCHAR," +
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS dailyreports(latitude VARCHAR,longitude VARCHAR,msg VARCHAR,cdt VARCHAR,rep_date VARCHAR," +
                "imagepath VARCHAR,status VARCHAR);");
    ...
    public void insertReport(String latitude, String longitude, String message, String cdt,
                             String rep_date, String imagepath, String status, Context context) {
        db = context.openOrCreateDatabase("RMAT", Context.MODE_PRIVATE, null);
        DBHelper.context = context;
        db.execSQL("INSERT INTO dailyreports VALUES('" + latitude + "','" + longitude + "','" +
                message + "','" + cdt + "','" + rep_date + "','" + imagepath + "','" + status + "');");
        db.close();
        Log.d("dbcreated_insert", "insertedsucess");
    }


    public void insertProject(String latitude, String longitude, String cdt, String address, String deviceid,
                              String deviceno, String status, String run, Context context) {
        db = context.openOrCreateDatabase("RMAT", Context.MODE_PRIVATE, null);
        DBHelper.context = context;
